        ...
        {stats && (
          <div className="grid lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-2 lg:sticky lg:top-4 space-y-4">
              ...
              {/* [DEV ONLY] أزرار اختبارية للـ Admin */}
              {process.env.NODE_ENV !== 'production' && (
                <div className="mt-4 p-4 bg-red-900/20 border border-red-500/30 rounded-xl">
                  <p className="text-red-400 text-xs font-bold mb-3 flex items-center gap-2">
                    🧪 أدوات تطوير (للاختبار فقط)
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <button
                      onClick={() => addTestReferrals(maxFloors * 5)}
                      className="px-3 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-xs rounded-lg transition flex items-center gap-1"
                    >
                      <Plus className="w-3 h-3" />
                      إضافة 5 مباني ({maxFloors * 5} إحالة)
                    </button>
                    <button
                      onClick={() => addTestReferrals(maxFloors)}
                      className="px-3 py-2 bg-blue-600 hover:bg-blue-500 text-white text-xs rounded-lg transition flex items-center gap-1"
                    >
                      <Plus className="w-3 h-3" />
                      إضافة مبنى ({maxFloors} إحالة)
                    </button>
                    <button
                      onClick={clearTestReferrals}
                      className="px-3 py-2 bg-red-600 hover:bg-red-500 text-white text-xs rounded-lg transition flex items-center gap-1"
                    >

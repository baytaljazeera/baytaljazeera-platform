    ...
    >
      ...
      {showDetailsModal && typeof document !== 'undefined' && createPortal(
        ...
        >
          ...
          >
            {/* صورة كبيرة */}
            <div style={{ position: "relative", height: 250, backgroundColor: "#1a1a1a" }}>
              {hasImages && !imgError ? (
                <img
                  src={allImages[imgIndex]}
                  alt={listing.title || "صورة العقار"}
            ...
            <div style={{ padding: 20 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                <div>
                  <div style={{ fontSize: 24, fontWeight: 700, color: "#D4AF37" }}>
                    {formatPriceArabic(listing.price, listing.price_currency)}
                  </div>
                  {listing.price_usd && (
                ...
                <div style={{ display: "flex", gap: 6 }}>
                  <span style={{
                    backgroundColor: listing.listing_type === "sale" ? "#01273C" : "#0B6B4C",
                    color: "#fff",
                    padding: "4px 10px",
                    borderRadius: 6,
                    fontSize: 12,
                    ...
                    {listing.listing_type === "sale" ? "بيع" : "إيجار"}
                  </span>
                </div>
              </div>
              ...
              <h2 style={{ fontSize: 18, fontWeight: 700, color: "#111827", marginBottom: 8 }}>
                {listing.title || "عقار مميز"}
              </h2>

              {/* الموقع */}
              {locationLine && (
                <div style={{ display: "flex", alignItems: "center", gap: 6, color: "#6b7280", marginBottom: 16 }}>
                  <MapPin size={16} />
                  <span>{locationLine}</span>
                </div>
              )}
              ...
              <div style={{ 
                ...
                {listing.bedrooms != null && (
                  <div style={{ textAlign: "center" }}>
                    <BedDouble size={20} style={{ margin: "0 auto 4px", color: "#D4AF37" }} />
                    <div style={{ fontSize: 16, fontWeight: 600 }}>{listing.bedrooms}</div>
                    <div style={{ fontSize: 11, color: "#6b7280" }}>غرف</div>
                  </div>
                )}
                {listing.bathrooms != null && (
                  <div style={{ textAlign: "center" }}>
                    <Bath size={20} style={{ margin: "0 auto 4px", color: "#D4AF37" }} />
                    <div style={{ fontSize: 16, fontWeight: 600 }}>{listing.bathrooms}</div>
                    <div style={{ fontSize: 11, color: "#6b7280" }}>حمام</div>
                  </div>
                )}
                {listing.area != null && (
                  <div style={{ textAlign: "center" }}>
                    <Square size={20} style={{ margin: "0 auto 4px", color: "#D4AF37" }} />
                    <div style={{ fontSize: 16, fontWeight: 600 }}>{listing.area}</div>
                    <div style={{ fontSize: 11, color: "#6b7280" }}>م²</div>
                  </div>
                )}
              </div>

...
async function elevenLabsTTSToMp3(text, voiceId) {
  ...
  const pronunciationDict = {
    ...
    'النرجس': 'النَّرجِس',
    'الملقا': 'المَلقا',
    'مجمعا تجاريا': 'مُجَمَّعًا تِجَارِيًّا',
    'مجمعا سكنيا': 'مُجَمَّعًا سَكَنِيًّا',
    'مجمعا طبيا': 'مُجَمَّعًا طِبِّيًّا',
    'المجمع': 'المُجَمَّع',
    'مجمع طبي': 'مُجَمَّع طِبِّي',
    'مجمع تجاري': 'مُجَمَّع تِجَارِي',
    'مجمع سكني': 'مُجَمَّع سَكَنِي',
    'مجمعا': 'مُجَمَّعًا',
    'مجمع': 'مُجَمَّع',
    'تواصل معنا': 'تَوَاصَلْ مَعَنَا',
    'تواصل': 'تَوَاصَلْ',
    'مستشفى': 'مُستَشفَى',
    'المستشفى': 'المُستَشفَى',
    'شقة': 'شُقَّة',
    'الشقة': 'الشُّقَّة',
    'شقق': 'شُقَق',
    'الشقق': 'الشُّقَق',
    ...
    'المعرض': 'المَعرِض',
    'مستودع': 'مُستَودَع',
    'المستودع': 'المُستَودَع',
    'استثنائيا': 'استِثنَائِيًّا',
    'استراتيجي': 'استِرَاتِيجِي',
    'الاستراتيجي': 'الاستِرَاتِيجِي',
    'استراحة': 'اِستِرَاحَة',
    'الاستراحة': 'الاِستِرَاحَة',
    'عيادة طبية': 'عِيَادَة طِبِّيَّة',
    'العيادة': 'العِيَادَة',
    'عيادة': 'عِيَادَة',
    'شقق فندقية': 'شُقَق فُندُقِيَّة',
    'محطة بنزين': 'مَحَطَّة بَنزِين',
    'المحطة': 'المَحَطَّة',
    'محطة': 'مَحَطَّة',
    'مطعم': 'مَطعَم',
    'المطعم': 'المَطعَم',
    ...
    'مزرعة': 'مَزرَعَة',
    'المزرعة': 'المَزرَعَة',
    // ─── Brand & taglines (must read correctly every time) ───
    'بيت الجزيرة': 'بَيت الجَزِيرَة',
    'بيت الجزيره': 'بَيت الجَزِيرَة',
    'الجزيرة': 'الجَزِيرَة',
    'الجزيره': 'الجَزِيرَة',
    // ─── Light/common words ElevenLabs Arabic v2 often clips or mis-stresses ───
    'هذا': 'هَذَا',
    'هذه': 'هَذِهِ',
    'هذان': 'هَذَانِ',
    'تلك': 'تِلْكَ',
    ...
    'بقلب': 'بِقَلْبِ',
    'وسط': 'وَسَطَ',
    // Numbers 1-10 — ElevenLabs sometimes reads digits as English; force Arabic words.
    'واحد': 'وَاحِد',
    'اثنان': 'اِثنَانِ',
    'ثلاثة': 'ثَلَاثَة',
    'أربعة': 'أَربَعَة',

...
async function generateDynamicPromoText(listingData) {
  ...
  const prompt = `أنت خبير تسويق عقاري خليجي محترف. اكتب 3 جمل تسويقية قوية ومشجعة لفيديو عقاري احترافي:

بيانات العقار:
- النوع: ${propertyType || "عقار"}
- الغرض: ${purpose || "للبيع"}  
- المدينة: ${city || "الخليج"}
- الحي: ${district || "موقع متميز"}
- السعر: ${formattedPrice || "سعر تنافسي"}
- المساحة: ${formattedArea || "مساحة مثالية"}
- المميزات: ${featuresText}

المطلوب - 3 جمل تسويقية احترافية:
1. headline: عنوان جذاب قوي (4-8 كلمات) - مثال: "فيلا الأحلام في قلب الرياض"
2. subheadline: وصف المميزات بشكل مشجع (5-10 كلمات) - مثال: "4 غرف فاخرة • حديقة خاصة • 350 م²"
3. priceTag: عرض السعر بطريقة جذابة - مثال: "فقط 1.2 مليون ريال" أو "استثمار مميز"

أسلوب الكتابة:
- استخدم كلمات قوية: فاخر، حصري، راقي، استثنائي، مميز، فرصة ذهبية
- اجعل الجمل مشجعة تحفز على الشراء
- بدون emoji
- عربي فصيح واضح ومختصر
...
// 🎬 توليد نص تحفيزي ثابت (احتياطي)
function generatePromotionalText(propertyType, purpose, city, district, price) {
  const cityPromotions = {
    "مكة المكرمة": ["في قلب مكة المكرمة النابض ✨", "على بُعد خطوات من الحرم الشريف 🕋", "استثمار مبارك في أطهر بقعة 🌙"],
    "المدينة المنورة": ["في طيبة الطيبة ✨", "قرب المسجد النبوي الشريف 🕌", "سكن مبارك في مدينة الرسول ﷺ"],
    "الرياض": ["في قلب العاصمة النابض 🏙️", "موقع استراتيجي في الرياض ⭐", "رفاهية العيش في العاصمة 👑"],
    "جدة": ["عروس البحر الأحمر 🌊", "إطلالة ساحرة على جدة ⭐", "حياة الرفاهية في جدة 🌴"],
    "الدمام": ["بوابة الخليج الشرقي 🌅", "موقع متميز في الدمام ⭐", "استثمار واعد في الشرقية 💎"],
    "الخبر": ["لؤلؤة الخليج العربي 🌊", "حياة عصرية في الخبر ⭐", "إطلالة بحرية ساحرة 🌅"],
    "الظهران": ["قلب المنطقة الشرقية 🏢", "موقع استثماري متميز 💎", "بوابة أرامكو والتقنية ⚡"],
    "الطائف": ["مدينة الورد والجمال 🌹", "في أحضان جبال السروات 🏔️", "صيف منعش ومناخ ساحر ❄️"],
    "أبها": ["عروس الجنوب الخضراء 🌲", "سحر الطبيعة والجبال 🏔️", "مناخ معتدل طوال العام 🌤️"],
    "تبوك": ["بوابة الشمال الواعدة 🌟", "موقع استثماري استراتيجي 📍", "أرض المستقبل والتطوير 🚀"],
    "بريدة": ["قلب القصيم النابض 💚", "أصالة وتراث عريق 🏛️", "فرص استثمارية واعدة 📈"],
    "حائل": ["مدينة الضيافة والكرم ☕", "تراث عريق ومستقبل مشرق ⭐", "استثمار في قلب الشمال 💎"],
    "جازان": ["لؤلؤة الجنوب الساحلية 🌴", "طبيعة خلابة ومناخ دافئ 🌺", "بوابة اليمن السعيد 🌊"],
    "نجران": ["مدينة الأخدود التاريخية 🏛️", "تراث عريق وطبيعة ساحرة 🌳", "استثمار في جنوب المملكة 💎"],
    "ينبع": ["مدينة الصناعة والبحر 🏭", "إطلالة على البحر الأحمر 🌊", "فرص استثمارية متميزة 📊"],
    "القطيف": ["واحة الخليج الخضراء 🌴", "تراث عريق وموقع متميز 🏛️", "قرب المنطقة الصناعية 🏢"],
    "الأحساء": ["واحة النخيل التاريخية 🌴", "تراث عالمي وجمال طبيعي 🌍", "أكبر واحة في العالم 🏆"],
    "الجبيل": ["مدينة الصناعة الحديثة 🏭", "بنية تحتية عالمية 🌐", "استثمار صناعي واعد 📈"],
    "خميس مشيط": ["قلب عسير النابض 💚", "مناخ معتدل وطبيعة خلابة 🌲", "موقع استراتيجي جنوبي ⭐"],
    "الخرج": ["سلة الغذاء السعودية 🌾", "أراضي زراعية خصبة 🌿", "قرب العاصمة الرياض 🏙️"],
  };

  const purposeText = purpose === "للبيع" 
    ? ["تملّك الآن بأفضل سعر 💰", "فرصة استثمارية لا تُفوّت 🏆", "استثمر في مستقبلك اليوم 📈"]
    : ["استأجر بأفضل المواصفات 🏠", "سكن راقٍ بإيجار مناسب ✨", "عش الرفاهية بأسعار منافسة 👑"];

  const typePromotions = {
    "فيلا": ["فيلا فاخرة تليق بذوقك الرفيع 🏛️", "تصميم عصري يجمع الأصالة والحداثة ✨"],
    "قصر": ["قصر ملكي بمواصفات استثنائية 👑", "عنوان الفخامة والرقي 🌟"],
    "شقة": ["شقة عصرية بتشطيبات فاخرة 🏢", "مساحات ذكية وتصميم أنيق ✨"],
    "أرض سكنية": ["أرض استثمارية بموقع متميز 📍", "فرصة ذهبية للبناء 🏗️"],
    "أرض تجارية": ["موقع تجاري استراتيجي 🏪", "استثمار مضمون العوائد 💎"],
  };

  const cityTexts = cityPromotions[city] || [`في قلب ${city} المتميز ⭐`];
  const typeTexts = typePromotions[propertyType] || ["عقار متميز بمواصفات عالية ✨"];
  
  return {
    headline: cityTexts[Math.floor(Math.random() * cityTexts.length)],
    subheadline: typeTexts[Math.floor(Math.random() * typeTexts.length)],
    callToAction: purposeText[Math.floor(Math.random() * purposeText.length)],
    tagline: "بيت الجزيرة - شريكك العقاري ✨",

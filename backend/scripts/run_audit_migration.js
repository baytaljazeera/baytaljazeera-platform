...
async function runMigration() {
  try {
    ...
    await db.query(`CREATE INDEX IF NOT EXISTS idx_audit_log_created_at ON permission_audit_log(created_at DESC)`);
    await db.query(`CREATE INDEX IF NOT EXISTS idx_audit_log_action_type ON permission_audit_log(action_type)`);
    ...
    console.log('Created indexes for custom roles');
